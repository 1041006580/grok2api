...
const resources = {
  "zh-CN": {
    translation: {
      ...
      accountType: { label: "类型", free: "Free", paid: "Super", pending: "待识别", pendingDescription: "账号状态正常，但额度类型尚未识别", auto: "Auto", super: "Super", heavy: "Heavy", console: "Console", xaiOfficial: "API Key" },
      accountBulk: {
      ...
      console: {
        name: "Grok Console",
        type: "Console",
        accountsDescription: "分别管理 Grok Build OAuth、Grok Web SSO、Grok Console SSO 与 xAI Official API Key 号池、健康状态、并发和额度。",
        egressDescription: "节点按 Grok Build、Grok Web、Grok Console、xAI Official 或 Web 资源作用域独立管理代理与健康状态。代理地址和 Cloudflare Cookie 仅写入。",
      ...
      xaiOfficial: {
        quickImport: "快速导入 API Key",
        quickImportTitle: "快速导入 xAI Official 账号",
        quickImportDescription: "支持粘贴多个官方 xAI API Key，或上传每行一个 Key 的 TXT 文件；重复项会自动忽略。",
        importFile: "导入账号文件",
        apiKeys: "xAI API Key（每行一个）",
        apiKeyPlaceholder: "xai-xxxxxxxxxxxxxxxx\nxai-yyyyyyyyyyyyyyyy",
      },
      accountCredential: {
        label: "凭据续期",
      ...
      dashboard: {
        ...
        successRate: "成功率",
        accountCount: "账号数",
        accountDistribution: "Build {{build}} · Web {{web}} · Console {{console}} · xAI {{xai}}",
      ...
      accounts: {
        title: "上游账号",
        description: "分别管理 Grok Build OAuth、Grok Web SSO、Grok Console SSO 与 xAI Official API Key 号池、健康状态和额度。",
        add: "接入账号",
        connectAccount: "账号接入",
        ...
        xaiOfficialAccountCount: "xAI Official 账号数",
      ...
      models: {
        title: "模型路由",
        description: "同一对外模型名称可映射到 Grok Build、Grok Web、Grok Console 与 xAI Official 的不同上游路由；多个对外名称也可指向同一上游模型。",
        sync: "同步模型",
        ...
        providerXAIOfficial: "xAI Official",
      ...
      keys: {
        ...
        accountScopeDescription: "模型列表会随渠道和订阅范围联动；调用仅在所选范围内选号，不会越界回退。全部订阅包含待识别，Free + Super 会排除待识别；Console 与 xAI Official 不受订阅限制。新建密钥默认不含 xAI Official，需要时请显式勾选。",
        rpmValue: "{{value}} RPM",
  ...
  en: {
    translation: {
      ...
      accountType: { label: "Type", free: "Free", paid: "Super", pending: "Pending", pendingDescription: "The account is healthy, but its quota type has not been identified yet.", auto: "Auto", super: "Super", heavy: "Heavy", console: "Console", xaiOfficial: "API Key" },
      accountBulk: {
      ...
      console: {
        name: "Grok Console",
        type: "Console",
        accountsDescription: "Manage separate Grok Build OAuth, Grok Web SSO, Grok Console SSO, and xAI Official API key pools, including health, concurrency, and quotas.",
        egressDescription: "Manage proxy and health independently for Grok Build, Grok Web, Grok Console, xAI Official, and Web asset scopes. Proxy URLs and Cloudflare cookies are write-only.",
      ...
      xaiOfficial: {
        quickImport: "Quick import API keys",
        quickImportTitle: "Quick import xAI Official accounts",
        quickImportDescription: "Paste multiple official xAI API keys or upload a TXT file with one key per line. Duplicate entries are ignored.",
        importFile: "Import account files",
        apiKeys: "xAI API keys (one per line)",
        apiKeyPlaceholder: "xai-xxxxxxxxxxxxxxxx\nxai-yyyyyyyyyyyyyyyy",
      },
      accountCredential: {
...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  ...
  fallbackXAIOfficialHelp: "Fallback used when no xAI Official primary egress is available.",
...
Object.assign(resources["zh-CN"].translation.settings.egress as unknown as Record<string, string>, {
  ...
  fallbackXAIOfficialHelp: "xAI Official 没有可用主出口时使用的回退方式。",
